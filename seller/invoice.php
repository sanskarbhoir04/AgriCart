...
.agi-brand-name{font-family:'Poppins',sans-serif;font-size:22px;font-weight:800;letter-spacing:-0.3px;line-height:1.15;color:var(--agi-dark-green);}
  ...
  <div class="agi-sheet agi-print-area" id="agiInvoiceSheet">
    ...
    <div class="agi-header-row">
      <div class="agi-brand">
        ...
        <?php endif; ?>
        <div>
          <div class="agi-brand-name"><?php echo agi_e($sellerDisplayName); ?></div>
